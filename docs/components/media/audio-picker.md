...
[[Method('Audio Picker', 'Set Animation Style', False, 'style', 'position', 'size', 'color')]]
...
[[Method('Audio Picker', 'Button Click', False)]]
...
[[Method('Audio Picker', 'Set Shadow', False, 'x', 'y', 'radius', 'color')]]
...
[[Method('Audio Picker', 'With Icon From Font Awesome', False, 'position', 'iconName', 'iconColor', 'padding', 'size')]]
...
[[Method('Audio Picker', 'With Icon From Material Font', False, 'position', 'iconName', 'iconColor', 'padding', 'size')]]
...
[[Method('Audio Picker', 'With Icon From Picture', False, 'position', 'picture', 'padding', 'width', 'height')]]
