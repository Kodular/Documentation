...
![image|239x142](https://cdn.community.kodular.io/original/3X/5/0/5047d5465fcfbd9f841d0e4c7600967f18a8b547.png)

* Added new **Keyguard Manager** component to _Utilities_ category
*Require the app to be unlocked using phone's security lock*
![image|243x161](https://cdn.community.kodular.io/original/3X/f/0/f0b4816737612d4dfd06bc71d686c7bd93a80ebe.png)
...
![image|252x144](https://cdn.community.kodular.io/original/3X/d/e/de1762e9d6c1c4f2c05430e2a5031f3b4e5d84c1.png)

* Added new **Dynamic Image** component to _Dynamic Components_ category
*Create more images in your apps execution*
![image|249x141](https://cdn.community.kodular.io/original/3X/2/8/28f7a9d840101fdc06179b79fe3e6d3d1ced5acc.png)
...
![image|248x140](https://cdn.community.kodular.io/original/3X/4/f/4f80e2ad0f8c9708f0e5ae75223cd89aeb85b62d.png)
...
![image|238x204](https://cdn.community.kodular.io/original/3X/1/a/1a5ac1181a16027f0b9c1a9d3c5e628dfd5e1125.png)
...
![image|245x160](https://cdn.community.kodular.io/original/3X/6/9/6968c8ca63a5eef8b8b271f106b18445866a21dc.png)

* Added new **AdColony Interstitial** component to _Monetization>Advertising_ category
*Insert AdColony ads in your apps*
![image|239x163](https://cdn.community.kodular.io/original/3X/b/d/bd5fbf7cc8a35a24ac210907064edb2b4c564e13.png)

* Added new **AppLovin** component to _Monetization>Advertising_ category
*Display AppLovin interstitials in your app*
![image|235x141](https://cdn.community.kodular.io/original/3X/d/0/d0df0fb0dbd47926bc471ce7a7b39589a516380a.png)
...
![image|241x183](https://cdn.community.kodular.io/original/3X/f/3/f30b524cc5ff2040cd5eb763b2ee1325b3c514af.png)
...
![image|243x158](https://cdn.community.kodular.io/original/3X/0/c/0c608ecc4d87fab8ee18f10639c30ef37e31cbb8.png)
...
![image|247x219](https://cdn.community.kodular.io/original/3X/8/8/88734b80653501baec71d00ffd603254aa0d9929.png)
...
![image|313x104](https://cdn.community.kodular.io/original/3X/0/e/0ee0c26f1e12baafdcd2fcc9b6c7ece3e244471c.png)

#### User Interface

* **Checkbox** component
	* `Click`: triggered only when an user interacts with a checkbox
![image|276x96](https://cdn.community.kodular.io/original/3X/4/9/49c34a888d19fc5e453205bbc2af2bf42a4e4911.png)

* **Slider** component
	* `Touch Down`: triggered when an user touches the slider
![image|236x74](https://cdn.community.kodular.io/original/3X/3/0/3025a764fbea97862ea37ffb8c70042033613187.png)
	* `Touch Up`: triggered when an user releases the slider
![image|221x78](https://cdn.community.kodular.io/original/3X/f/c/fc966318a33907c32c46e924b4e1a94c1b5f038d.png)

#### Media

* **ExoPlayer** component
	* `Completed`: triggered when the track finishes reaches the end
![image|257x77](https://cdn.community.kodular.io/original/3X/8/8/88b9e381ff100a465b823ce44e24be2771824712.png)

#### Social

* **Push Notifications** component
	* `Send Message Done`: triggered when the message has been successfully sent
![image|381x105](https://cdn.community.kodular.io/original/3X/e/a/eaace06ee8d5ed623c326effa08fd700d156da3c.png)

#### Connectivity

* **Download** component
	* `On Download Progress Changed`: triggered when the progress of a download changes
![image|400x98](https://cdn.community.kodular.io/original/3X/d/e/dea5285267bac7f7350ad1f6dbbb6a1cf543705e.png)

#### Google

* **Firebase Authentication** component
	* `Got Id Token`: triggered when Firebase gets the ID Token
![image|362x111](https://cdn.community.kodular.io/original/3X/e/a/ea248c413753d58a6eedac2c8c3ecc70bc77d09f.png)
	* `Reset Password Email Done`: raised once the email to reset password has been sent
![image|476x103](https://cdn.community.kodular.io/original/3X/3/4/34c44295b8c48eb41e6e45d4e4efeffa33f82d5d.png)

* **YouTube Player** component
	* `Initialized`: triggered when the component has been loaded and it's ready
![image|283x84](https://cdn.community.kodular.io/original/3X/3/3/33bf103e48b1d08f31d9e51e9adc97f47742ca9e.png)
...
![image|239x46](https://cdn.community.kodular.io/original/3X/2/e/2ef2902f886423ed537c5342e2fde9ea39a5f462.png)

#### Layout>Navigation

* **View Pager** component
	* `Remove All Tabs`: deletes all created tabs
![image|296x45](https://cdn.community.kodular.io/original/3X/c/d/cdcfd51a9206350bd027dc3c7a689f5bcccb509a.png)

#### Social

* **Push Notifications** component
	* `Send Message`: sends a push notification to the subscribed users
![image|340x121](https://cdn.community.kodular.io/original/3X/0/c/0ce945e451270f07fe63f05e2accadc117d9cac7.png)
...
![image|378x47](https://cdn.community.kodular.io/original/3X/8/7/8735c7c4fb3ef440abbc04aec7b20653b2623e87.png)
	* `Is Emulator`: returns true when the app is running in an emulator
*Thanks to [@Cian](https://community.kodular.io/u/cian) for this block*
![image|278x44](https://cdn.community.kodular.io/original/3X/9/c/9ca097c174fe69ad2a0f6c9802efbccc965ae672.png)
	* `Is Installed From Play Store`: returns true when the app was installed from Google Play Store
*Thanks to [@Cian](https://community.kodular.io/u/cian) for this block*
![image|388x48](https://cdn.community.kodular.io/original/3X/e/1/e1adccd438e87747df87536deef7fcb6a2480346.png)
	* `Has Dangerous Apk Installed`: returns true when the user has apps like *Lucky Pather* or *Xposed Installer*
*Thanks to [@Cian](https://community.kodular.io/u/cian) for this block*
![image|388x50](https://cdn.community.kodular.io/original/3X/b/1/b1b1e54d6bcb3a1fc0c341ee6ef29fa6d7b0b1d8.png)

#### Dynamic Components

* **Dynamic Button** component
	* `Delete Button`: deletes the given generated button
![image|297x68](https://cdn.community.kodular.io/original/3X/2/9/29c02f1204a3058880d890c599dda66d1c708844.png)

* **Dynamic Label** component
	* `Delete Label`: deletes the given generated label
![image|294x70](https://cdn.community.kodular.io/original/3X/3/f/3f4717a9d897b6568d12dc4d6f964fc90beeca50.png)

* **Dynamic Textbox** component
	* `Delete Textbox`: deletes the given generated textbox
![image|340x68](https://cdn.community.kodular.io/original/3X/e/a/eab8adee3f8be3ba8e36e5c7994c9cc22ac16841.png)

### Google

* **Firebase Authentication** component
	* `Get Id Token`: retreives from Firebase the id for the current user
![image|347x45](https://cdn.community.kodular.io/original/3X/9/3/938f0f62f7645ffecf397c3521a9c7692d9831db.png)
	* `Phone Number Sign In`: authenticates the user using the given phone number sending an OTP code
![image|421x70](https://cdn.community.kodular.io/original/3X/6/0/609c961324f8a3534a231f7ca85799c2f4985d32.png)
	* `Send Reset Password Email`: sends an email to the user to change the password
![image|458x72](https://cdn.community.kodular.io/original/3X/a/c/acd46b7de8dc7e16d6fb57292107d13f49c57f50.png)
	* `Update Phone Number`: changes the user's phone number
![image|421x74](https://cdn.community.kodular.io/original/3X/d/b/db456bb6c4fb9d3c3bb2825399100dba3be00a2f.png)
	* `Verify Email`: sends a confirmation email to verify user's email address
![image|340x47](https://cdn.community.kodular.io/original/3X/2/9/293c150c63128fadcb57afff6b98ff1b406aa476.png)
	* `Verify Phone Code`: checks if the given OTP code is valid
![image|394x66](https://cdn.community.kodular.io/original/3X/8/0/805539c8b538f6620e829c0326ee0c383e4c6649.png)

* **Firebase Remote Config** component
	* `Get Boolean`: returns a boolean value from Firebase
![image|379x75](https://cdn.community.kodular.io/original/3X/c/0/c0b82c619723c5151acbbb62218f91a02a79d6f0.png)

* **Google Maps** component
	* `Add Polyline`: inserts a polyline in the map and returns its id
![image|301x117](https://cdn.community.kodular.io/original/3X/8/b/8b4de43aa1302be75652aed574a1d4ed0577ba30.png)
	* `Get All Polyline Ids`: returns all available polyline ids on the map
![image|328x45](https://cdn.community.kodular.io/original/3X/6/c/6ce3efa66144184f75a64f255fd424c6f8ee700a.png)
	* `Get Points From Json`: returns an object containing all points in a JSON string, which can be used in polylines
![image|356x65](https://cdn.community.kodular.io/original/3X/5/8/583115b83ae17d40eb254596ce142bedb9a3d92b.png)
	* `Remove Polyline`: deletes the given polyline from the map and returns true if it has been removed properly
![image|329x75](https://cdn.community.kodular.io/original/3X/0/f/0f43a763951cd024e729c1ad82a5a945325a9503.png)
...
![image|306x122](https://cdn.community.kodular.io/original/3X/b/c/bccee3f2400deb06110ea5f2c0c44f4f6dc01572.png)
...
*Thanks to [@Cian](https://community.kodular.io/u/cian) for this block*
![image|244x40](https://cdn.community.kodular.io/original/3X/6/3/6325bcc667cc57ffdfafa24bcc46ae960e9718bb.png)
	* `Has Super User Apk Installed`: returns true when phone has installed super user apps, even if it is not rooted
*Thanks to [@Cian](https://community.kodular.io/u/cian) for this block*
![image|340x45](https://cdn.community.kodular.io/original/3X/6/1/61746e4a96061e33040e2e9b2aa2eba6a815f84b.png)
...
![image|375x47](https://cdn.community.kodular.io/original/3X/0/f/0f6be8cbd4c13673bcd4b66ccbc90c2c5074e8a8.png)

* `Navigation Icon Color`: sets the color of the drawer's icon
![image|351x46](https://cdn.community.kodular.io/original/3X/2/b/2b61ee8418ba5b56455386fe2f2cd77f19cc8766.png)

* `Options Menu Icon Color`: sets the color of the option's menu icon
![image|373x43](https://cdn.community.kodular.io/original/3X/3/3/331f981cad592964adf69a1bd6caf500ca2f6d93.png)
...
![image|281x156](https://cdn.community.kodular.io/original/3X/d/f/df1166a3b37c54987bac6f5b67b7f123701e9d19.png)

### User Interface

* **Floating Action Button** component
	* `Call Fab Click Event When Label Clicked`: enables triggering the click event when clicking on the message
![image|342x60](https://cdn.community.kodular.io/original/3X/8/a/8a4343a0f703041efbc973c8a1f91b5723c46fa7.png)
	* `Call Fab Click Event When Label Long Clicked`: enables triggering the click event when long-clicking on the message
![image|331x62](https://cdn.community.kodular.io/original/3X/a/6/a6c93e1390cf38c33c37d5dcfaab1374295424c0.png)
	* `Hide Label When Clicked`: enables hidding the message when clicking on it
![image|332x39](https://cdn.community.kodular.io/original/3X/c/e/ce1e7cd22d040a9df0ee473297e53387c9e66a0f.png)
	* `Hide Label When Long Clicked`: enables hidding the message when long-clicking on it
![image|335x43](https://cdn.community.kodular.io/original/3X/0/c/0c9d9c6869ad5dc266a5651c5ffcd608eacb06bf.png)
	* `Show Label On Left Side`: shows the text message to the left of the FAB
![image|345x41](https://cdn.community.kodular.io/original/3X/8/3/83805cc5830879ae01336e316b035f8f8b369002.png)
	* `Label Background Color`: sets the background color of the text message
![image|347x79](https://cdn.community.kodular.io/original/3X/0/2/02140967b5faf29aabf10fc6bcc8ebb7e5946252.png)
	* `Label Corner Radius`: sets the corner radius of the text message
![image|345x80](https://cdn.community.kodular.io/original/3X/2/4/248d25a6325937e041aef7e2d535d39a0f31320e.png)
	* `Label Text`: enables and sets the text of the FAB's text message
![image|348x73](https://cdn.community.kodular.io/original/3X/d/6/d6a716a5c07fb2664f5af0fd3a344d467d87cf39.png)
	* `Label Text Color`: sets the text color of the text message
![image|347x72](https://cdn.community.kodular.io/original/3X/f/8/f8e224b3fd9ccd2743be2ef5688573a449937a95.png)

### Layout>General

* **Card View** component
	* `Stroke Color`: changes the stroke's color of the card
![image|272x66](https://cdn.community.kodular.io/original/3X/d/6/d69b3e31d73895c0c3f6ce65ce16fe7f5ff671f2.png)
	* `Stroke Width`: changes the stroke's width of the card
![image|272x59](https://cdn.community.kodular.io/original/3X/f/a/fa011b04b0b9ab6ae15e71c7f7179fd758f52f51.png)
...
*Thanks to [@Cian](https://community.kodular.io/u/cian) for this block*
![image|282x51](https://cdn.community.kodular.io/original/3X/3/b/3b9301cda115b42bc6aeb0b9a371d6157f9bf4c8.png)

### Monetization

* **Admob Interstitial** component
	* `Interstitial Commission`: specifies which ad network will be used to take the commission
![image|270x62](https://cdn.community.kodular.io/original/3X/9/3/93f101177366c6e9ca7042b6038b189161fa64f7.png)
...
![image|272x62](https://cdn.community.kodular.io/original/3X/3/8/38dfdab500eda09fa36c41059b8f7f0eb6d0504d.png)
...
![image|332x124](https://cdn.community.kodular.io/original/3X/e/c/ecbd6dcff2347c628f500e66ecad005bf143bfe6.png)
	* `Update Subscription`: with the new library, there is no function associated to it
![image|428x81](https://cdn.community.kodular.io/original/3X/b/3/b3e80bb1c51ba78759a81bc1ff7ea6c4c481f3c1.png)
...
![image|429x81](https://cdn.community.kodular.io/original/3X/3/0/30ff7b109f4ded5b58c70879c2bcc50339767521.png)

* **Dynamic Card View** component
  * `Get Card View By Id`: returns the view containing the generated dynamic cardview
![image|498x80](https://cdn.community.kodular.io/original/3X/0/1/017859d30508e65861f13318af91e27dca3ee7ae.png)

* **Dynamic Image** component
  * `Get Image By Id`: returns the view containing the generated dynamic image
![image|425x83](https://cdn.community.kodular.io/original/3X/c/6/c6beeffb9428f5bea754feaea7b06fe9cb9760fb.png)

* **Dynamic Label** component
  * `Get Label By Id`: returns the view containing the generated dynamic label
![image|408x78](https://cdn.community.kodular.io/original/3X/c/0/c09d2f56720123914b80b7cba7fbcbc2c2dade58.png)

* **Dynamic Space** component
  * `Get Space By Id`: returns the view containing the generated dynamic space
![image|426x81](https://cdn.community.kodular.io/original/3X/a/2/a247b91b2aabe1c5a01fca268039b77da7a4e9f5.png)

* **Dynamic Text Box** component
  * `Get Text Box By Id`: returns the view containing the generated dynamic textbox
![image|448x81](https://cdn.community.kodular.io/original/3X/b/5/b58d4d3f2a4bb984b8d1fc15d52194ce9af9487d.png)
...
![image|287x55](https://cdn.community.kodular.io/original/3X/2/b/2b189aa0f88f1884956e1f7ba1c19d090b974b20.png)

### New Events

* Added **Got Value** event to *Push Notifications*
![image|380x116](https://cdn.community.kodular.io/original/3X/3/8/384026e5b5f77c4afb8a6ecbc6a36bbfc5bc9225.png)

### New Events

* Added **Get Value** method to *Push Notifications*
![image|372x106](https://cdn.community.kodular.io/original/3X/2/3/23d7c3ad91142e203c1a215589fcb4616b9cd7d5.png)
...
![Screen Shot 2019-12-24 at 00.07.54|250x148](https://cdn.community.kodular.io/original/3X/e/d/edf4faa9c12bf420adbb4c5a9b0fecd089a79286.png)

* New **Grid View** component in Layout > General.
![Screen Shot 2019-12-24 at 00.12.05|250x148](https://cdn.community.kodular.io/original/3X/4/8/48992b63273b384d8f90077b4a6c21d9556104e2.png)

* New **Gallery View** component in Layout > Views.
![Screen Shot 2019-12-24 at 00.09.56|250x148](https://cdn.community.kodular.io/original/3X/8/b/8b57382d4bf253f6800c97319bcb7d3d1628a0a7.png)
...
![Screen Shot 2019-12-24 at 00.15.16|250x168](https://cdn.community.kodular.io/original/3X/e/3/e31c8a5de89030cff5f570bd68a2ca1e754be6f0.png)

* New **Battery Utilities** component in Utilities.
![Screen Shot 2019-12-24 at 00.13.48|250x148](https://cdn.community.kodular.io/original/3X/d/7/d7a7b8aef5512b7cbde4683078f63ffc803b0b01.png)

* New **Decoration** component in Utilities.
![Screen Shot 2019-12-24 at 00.13.00|250x168](https://cdn.community.kodular.io/original/3X/d/c/dc46fb58efae51296f4d0460f6e5eb377d0670e7.png)

* New **Firebase Storage** component in Google.
![Screen Shot 2019-12-24 at 00.15.44|250x128](https://cdn.community.kodular.io/original/3X/7/9/793955644b9b93ca4e8ffed9be20eb5e91c675d1.png)
...
![component_event|355x85](https://cdn.community.kodular.io/original/3X/8/8/88d8fb2f978e464ddba28d821224b9304baff31b.png)
...
![component_method|273x129](https://cdn.community.kodular.io/original/3X/b/d/bd24f28affaae217fb940b19f889ea82006061c7.png)

* **Date Picker**
    * New **Set Animation Style** method.
*Inserts an animated image inside the component.*
![component_method|311x129](https://cdn.community.kodular.io/original/3X/c/5/c5cfbb1e8d8456765ea8fd74390172f4855c3c90.png)

* **Label**
    * New **Set Animation Style** method.
*Inserts an animated image inside the component.*
![component_method|265x129](https://cdn.community.kodular.io/original/3X/a/0/a0e15263f22a6fccb92a1488c841c96b68c6d697.png)

* **List Picker**
    * New **Set Animation Style** method.
*Inserts an animated image inside the component.*
![component_method|302x129](https://cdn.community.kodular.io/original/3X/2/5/257469eb41c96d095b4ee4e27977f1b5d84c6179.png)

* **Textbox**
    * New **Set Animation Style** method.
*Inserts an animated image inside the component.*
![component_method|289x129](https://cdn.community.kodular.io/original/3X/b/3/b3498741f1f580093071104450545bcf925931b5.png)

* **Time Picker**
    * New **Set Animation Style** method.
*Inserts an animated image inside the component.*
![component_method|311x129](https://cdn.community.kodular.io/original/3X/7/7/7767358f410b0985880af844cda4c9518ed4c910.png)
...
* **Audio Picker**
    * New **Set Animation Style** method.
*Inserts an animated image inside the component.*
![component_method|315x129](https://cdn.community.kodular.io/original/3X/3/4/348207cf18c71cd66aa04f0b665961c583b8c52c.png)

* **Image Picker**
    * New **Set Animation Style** method.
*Inserts an animated image inside the component.*
![component_method|319x129](https://cdn.community.kodular.io/original/3X/6/8/68b8e6fc6cd2aeb05f9f89526383296f80221ee0.png)

* **Video Picker**
    * New **Set Animation Style** method.
*Inserts an animated image inside the component.*
![component_method|315x129](https://cdn.community.kodular.io/original/3X/b/c/bcdd23fe9e4cade1bec7e92bee1988b8a05ec506.png)
...
![component_method|245x204](https://cdn.community.kodular.io/original/3X/9/1/918821e84b984321d3d73a06210c78e529934835.png)
...
* **Contact Picker**
    * New **Set Animation Style** method.
*Inserts an animated image inside the component.*
![component_method|330x129](https://cdn.community.kodular.io/original/3X/3/d/3d513e8177b137b118d923ad37e35bdbf2671ef1.png)

* **Email Picker**
    * New **Set Animation Style** method.
*Inserts an animated image inside the component.*
![component_method|316x129](https://cdn.community.kodular.io/original/3X/7/5/75a94ce78899656a425f762cf923ce34a5edf4b4.png)

* **Phone Number Picker**
    * New **Set Animation Style** method.
*Inserts an animated image inside the component.*
![component_method|381x129](https://cdn.community.kodular.io/original/3X/7/e/7ef585d38e2dd43775802405931cb58769c3b735.png)
...
![component_method|275x26](https://cdn.community.kodular.io/original/3X/9/1/91623a36a4c2fffdd6ee5fae35d59793a05b7bba.png)

    * New **Is Mobile Connection** method.
*Returns true if the device is connected to a mobile network, false otherwise.*
![component_method|291x26](https://cdn.community.kodular.io/original/3X/3/8/38cac48a84268e945501a58e59be427edcf26159.png)

    * New **Is Fast Connection** method.
*Returns true if the current connection speed is greater than 400kb/s.*
![component_method|279x26](https://cdn.community.kodular.io/original/3X/7/7/77c80f6761e62910960037ca35746246985e30a1.png)

    * New **Is Roaming** method.
*Returns true if using roaming; false otherwise.*
![component_method|231x26](https://cdn.community.kodular.io/original/3X/5/d/5d0ee8c792ef530604cce991a3eaa63fa19a4ae8.png)
...
![blocks|239x30](https://cdn.community.kodular.io/original/3X/b/6/b6595805d571c967e6882fb10a115add83ec8f39.png)
![component_set_get|179x26, 100%](https://cdn.community.kodular.io/original/3X/1/d/1d2a15d849d725d623afe713ca0378809e9e8dec.png)
...
![Screen Shot 2019-12-23 at 23.56.37|287x32](https://cdn.community.kodular.io/original/3X/f/8/f8f3485e857c2d58e8240a7b3662d5f9f62c745f.png)
...
![blocks|404x30](https://cdn.community.kodular.io/original/3X/9/d/9d40f9b3ec290a786cda51bd4105a39a83e2b8c3.png)
![component_set_get|344x26](https://cdn.community.kodular.io/original/3X/4/4/4491f155b1636f42504a0087d12433eceaa53071.png)
...
![fill_opacity|287x66](https://cdn.community.kodular.io/original/3X/3/b/3bae95c5941d6639d85fbe05a990da0402001ee8.png)
![blocks|264x30](https://cdn.community.kodular.io/original/3X/9/c/9ca3ed8dd445dca2db7dbb675c32f736d9f9b131.png)
![component_set_get|204x26](https://cdn.community.kodular.io/original/3X/9/c/9c803d3d81a9fb5503a4e51bac95cbc324097a8c.png)

    * New **Stroke Opacity** property.
*[Support fill-opacity/stroke-opacity for map features (#1859) · mit-cml/appinventor-sources@fca2c24 · GitHub](https://github.com/mit-cml/appinventor-sources/commit/fca2c244331c7f9cfc270d11937a039bba361fd5)*
![stroke_opacity|287x66](https://cdn.community.kodular.io/original/3X/4/9/4959ba18d687fb4382dbd5ed9c1a1a3a9a3c92e5.png)
![blocks|288x30](https://cdn.community.kodular.io/original/3X/f/5/f5c463144e34630d13155438b4b888619b608e6a.png)
![component_set_get|228x26](https://cdn.community.kodular.io/original/3X/6/9/693f397ac7f7024ea9f42fae2efbefeb353d49b9.png)
...
*[Support fill-opacity/stroke-opacity for map features (#1859) · mit-cml/appinventor-sources@fca2c24 · GitHub](https://github.com/mit-cml/appinventor-sources/commit/fca2c244331c7f9cfc270d11937a039bba361fd5)*
![stroke_opacity|287x66](https://cdn.community.kodular.io/original/3X/4/9/4959ba18d687fb4382dbd5ed9c1a1a3a9a3c92e5.png)
![blocks|323x30](https://cdn.community.kodular.io/original/3X/7/3/73483023922511b9152282b50ff9b3e5adf6d967.png)
![component_set_get|263x26](https://cdn.community.kodular.io/original/3X/3/7/37b536ad207708cbaef728b74206742d8d777afd.png)

* **Marker**
    * New **Fill Opacity** property.
*[Support fill-opacity/stroke-opacity for map features (#1859) · mit-cml/appinventor-sources@fca2c24 · GitHub](https://github.com/mit-cml/appinventor-sources/commit/fca2c244331c7f9cfc270d11937a039bba361fd5)*
![fill_opacity|287x66](https://cdn.community.kodular.io/original/3X/3/b/3bae95c5941d6639d85fbe05a990da0402001ee8.png)
![blocks|270x30](https://cdn.community.kodular.io/original/3X/f/9/f95a76a81de8a04cb4310155f8eddafebcaf4569.png)
![component_set_get|210x26](https://cdn.community.kodular.io/original/3X/4/5/453ad5a7478f91be5badd19092301bcf520d8095.png)

    * New **Stroke Opacity** property.
*[Support fill-opacity/stroke-opacity for map features (#1859) · mit-cml/appinventor-sources@fca2c24 · GitHub](https://github.com/mit-cml/appinventor-sources/commit/fca2c244331c7f9cfc270d11937a039bba361fd5)*
![stroke_opacity|287x66](https://cdn.community.kodular.io/original/3X/4/9/4959ba18d687fb4382dbd5ed9c1a1a3a9a3c92e5.png)
![blocks|294x30](https://cdn.community.kodular.io/original/3X/d/a/dac4cdc8b6450285f427837467fed31ac66fd5ac.png)
![component_set_get|234x26](https://cdn.community.kodular.io/original/3X/5/7/57ba320ea8b18837b13a90043add18fd2df92030.png)

* **Polygon**
    * New **Fill Opacity** property.
*[Support fill-opacity/stroke-opacity for map features (#1859) · mit-cml/appinventor-sources@fca2c24 · GitHub](https://github.com/mit-cml/appinventor-sources/commit/fca2c244331c7f9cfc270d11937a039bba361fd5)*
![fill_opacity|287x66](https://cdn.community.kodular.io/original/3X/3/b/3bae95c5941d6639d85fbe05a990da0402001ee8.png)
![blocks|278x30](https://cdn.community.kodular.io/original/3X/8/a/8a847168d7a0ab8c4e0c3a4e94730ac25c7ba607.png)
![component_set_get|218x26](https://cdn.community.kodular.io/original/3X/9/8/98301a0f1dcbad4565a6725200990547eb5c4ef4.png)

    * New **Stroke Opacity** property.
*[Support fill-opacity/stroke-opacity for map features (#1859) · mit-cml/appinventor-sources@fca2c24 · GitHub](https://github.com/mit-cml/appinventor-sources/commit/fca2c244331c7f9cfc270d11937a039bba361fd5)*
![stroke_opacity|287x66](https://cdn.community.kodular.io/original/3X/4/9/4959ba18d687fb4382dbd5ed9c1a1a3a9a3c92e5.png)
![blocks|302x30](https://cdn.community.kodular.io/original/3X/c/5/c52402592d8cdf5ab98547c339d9220303ac63e4.png)
![component_set_get|242x26](https://cdn.community.kodular.io/original/3X/8/e/8e034e83597b7f434f57c8959bf7f137edb20df9.png)

* **Rectangle**
    * New **Fill Opacity** property.
*[Support fill-opacity/stroke-opacity for map features (#1859) · mit-cml/appinventor-sources@fca2c24 · GitHub](https://github.com/mit-cml/appinventor-sources/commit/fca2c244331c7f9cfc270d11937a039bba361fd5)*
![fill_opacity|287x66](https://cdn.community.kodular.io/original/3X/3/b/3bae95c5941d6639d85fbe05a990da0402001ee8.png)
![blocks|292x30](https://cdn.community.kodular.io/original/3X/c/b/cb5e22c826fcf17fffe4a86cc9aeb3b72860097e.png)
![component_set_get|232x26](https://cdn.community.kodular.io/original/3X/3/d/3d7d18fa8a5556d62bda076c6e96bdd36c7a6922.png)

    * New **Stroke Opacity** property.
*[Support fill-opacity/stroke-opacity for map features (#1859) · mit-cml/appinventor-sources@fca2c24 · GitHub](https://github.com/mit-cml/appinventor-sources/commit/fca2c244331c7f9cfc270d11937a039bba361fd5)*
![stroke_opacity|287x66](https://cdn.community.kodular.io/original/3X/4/9/4959ba18d687fb4382dbd5ed9c1a1a3a9a3c92e5.png)
![blocks|316x30](https://cdn.community.kodular.io/original/3X/8/a/8ad0571d235d0486ceaccfc4932285ae5a86593d.png)
![component_set_get|256x26](https://cdn.community.kodular.io/original/3X/b/a/ba7d99b6573c14d3486954b0bfadbd79bc524733.png)
...
![Screen Shot 2019-12-24 at 00.05.00|295x66](https://cdn.community.kodular.io/original/3X/8/5/856f9888bcbb5de04932721394f4d9e94f6a6fb9.png)
![blocks|237x30](https://cdn.community.kodular.io/original/3X/3/b/3bdd01b905602d1c93d38764e71e54bb6b792e46.png)
![component_set_get|177x26](https://cdn.community.kodular.io/original/3X/c/9/c9154cdbb0b30ba3ae0c04d06ed358a7a958562b.png)
...
![Screen Shot 2019-12-24 at 00.06.20|295x66](https://cdn.community.kodular.io/original/3X/f/d/fd4f3a7f5939eb753f62a96814288c60f8c431eb.png)
...
![image|310x300, 75%](https://cdn.community.kodular.io/original/3X/9/5/954ee5e215ae7f3ae29d867597574476ae2dcbbc.png)
...
![component_method|243x26](https://cdn.community.kodular.io/original/3X/5/9/59136ef57d4f7dc5777d9a597693ca36b45d5fb7.png)

	* New **Drop Table** method.
*Removes the given table from the database.*
![component_method (1)|227x50](https://cdn.community.kodular.io/original/3X/6/5/653e8497e2f03c115243abe71bce1cd8b677269c.png)

	* New **SQL Query** method.
*Executes the given raw SQL query and returns result synchronously (same block).*
![component_method (2)|229x50](https://cdn.community.kodular.io/original/3X/e/e/ee5991a085ec41e97887d1065bb015a2f8ca4364.png)
...
![component_set_get|232x26](https://cdn.community.kodular.io/original/3X/9/d/9d6f58b4ab76aa9b47f0e8d2c6cc1e803e830254.png)
...
![component_method|232x25](https://cdn.community.kodular.io/original/3X/b/0/b02a615d47eb20d7abc1e76cbe327ef2c66b91ea.png)
...
![image|260x231](https://cdn.community.kodular.io/original/3X/e/3/e30f30baefcc59da6dd65139bbfea94ff8c7da78.png)
